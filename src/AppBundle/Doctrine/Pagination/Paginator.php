...
namespace AppBundle\Doctrine\Pagination;
...
class Paginator implements \Countable, \IteratorAggregate
{
    ...
    public function getIterator()
    {
        ...
        if ($this->fetchJoinCollection) {
            ...
            $this->appendTreeWalker($whereInQuery, 'AppBundle\Doctrine\Pagination\WhereInWalker');
     ...
     */
    private function cloneQuery(Query $query, $cloneParameter = true)
    {
